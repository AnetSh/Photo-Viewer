...
public class MyController {
    ...
    /**
     * View all ids from photos
     * @param model
     * @return
     */
    @RequestMapping(value ="/viewAllId", method = RequestMethod.GET)
    public String onViewAllId(Model model) {
        model.addAttribute("photos",photos);
        return "viewAllPhotos";
    }

    /**
     * Delete ids from photos
     * @param photoId
     * @return
     */
    @RequestMapping(value = "/deletePhotos", method = RequestMethod.POST)
    public String onDeletePhotos(@RequestParam("photos") long[] photoId) {
        for (long id : photoId)
            photos.remove(id);
        return "index";
    }
